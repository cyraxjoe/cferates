...
let
  ...
  # Create a virtual environment containing all dependencies (including dev)
  virtualenv = pythonSet.mkVirtualEnv "cferates-dev-env" workspace.deps.all;
...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "Welcome to the cferates development shell with uv2nix!"
  '';
}
